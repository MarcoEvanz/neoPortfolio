...
const storeApps: StoreApp[] = [
  ...
  },
  {
    ...
    description: "Play classic NES games in your browser with EmulatorJS. Upload .nes files or enter a URL. Supports save states, custom controls, and fullscreen.",
    icon: <IoGameController className="text-2xl" />,
  ...
  },
  {
    id: "snesemulator",
    name: "SNES Emulator",
    subtitle: "Super Nintendo Player",
    description: "Play Super Nintendo games in your browser with EmulatorJS. Upload .sfc or .smc files, or enter a URL. Supports save states, custom controls, and fullscreen.",
    icon: <IoGameController className="text-2xl" />,
  ...
  },
  {
    id: "n64emulator",
    name: "N64 Emulator",
    subtitle: "Nintendo 64 Player",
    description: "Play Nintendo 64 games in your browser with EmulatorJS. Upload .z64, .n64, or .v64 files, or enter a URL. Supports save states, custom controls, and fullscreen.",
    icon: <IoGameController className="text-2xl" />,
  ...
  },
  {
    ...
    description: "3DS emulation requires OpenGL 3.3+ which is not available in browsers yet. Waiting for WebGPU support. In the meantime, try Azahar or Lime3DS on desktop.",
    icon: <IoGameController className="text-2xl" />,
